...
$APPLICATION->SetPageProperty("title-top", "Бриф на интеграцию");
...
<div class="top_menu_brief">
    <div class="top_menu_brief_inner_1">
        <a href="/brief/?brief=1C_brief" <?if ($br == null || $br == "1C_brief"){?>class="top_menu_brief_inner_hover"<?}?>>1С и 1С-Битрикс</a>
    </div>
    <div class="top_menu_brief_inner_2">
        <a href="/brief/?brief=24brief" <?if ($br == "24brief"){?>class="top_menu_brief_inner_hover"<?}?>>1С и Битрикс24</a>
    </div>
</div>
